...
<br>
Color-coded terminal output (e.g., red for high priority, yellow for pending, green for completed)
<br>
Sort and filter tasks by priority, status, or due date
<br>
